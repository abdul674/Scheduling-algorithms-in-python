...
number_of_process = number_of_process("How many processes are there : ", 0)
...
for index in range(number_of_process):
    ...
    arrival_time = number_of_process("Arrival Time of p{number} : ".format(number=number), 0)
    burst_time = number_of_process("Burst Time of p{number} : ".format(number=number), 1)
